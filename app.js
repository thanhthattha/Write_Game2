...
var app = (function () {
  ...
  function R(e, t) {
    -1 === e.$$.dirty[0] && (A.push(e), S || ((S = !0), M.then(L)), e.$$.dirty.fill(0)), (e.$$.dirty[(t / 31) | 0] |= 1 << t % 31);
  }
    ...
    if (
      ((f.ctx = r
        ? r(t, u, (e, n, ...r) => {
            ...
            return f.ctx && l(f.ctx[e], (f.ctx[e] = s)) && (f.bound[e] && f.bound[e](s), h && R(t, e)), n;
          })
        : []),
      f.update(),
      (h = !0),
  ...
  var Y = (() => {
    ...
    ne = (() => {
      ...
      return {
        ...
        log: function () {
          t.words++, (t.time = ee(new Date()) - e), (t.speed = (t.words / t.time) * 1e3 * 60), r(t);
        },
  ...
  const oe = (e, t = 50) => {
    const n = e / t;
    return n >= 1 ? "fastest" : n >= 0.9 ? "fast" : n >= 0.8 ? "normal" : n >= 0.7 ? "slow" : "slowest";
  };
  let ae = {};
  function le() {
    for (let e = 97; e < 123; e++) ae[String.fromCharCode(e)] = { typed: 0, time: 0, speed: 0 };
  }
  le();
  var ie = (() => {
    let e = null;
          ...
          ae[t.key] &&
            (e
              ? (ae[t.key].typed++,
                ...
                (ae[t.key].speed = ((r = ae[t.key]), Math.round((r.typed / r.time) * 12e3))),
  ...
  var ue = (() => {
      ...
      function t() {
        ie.updateKey(e), ce.char < de[ce.word].length - 1 ? Z.nextChar() : ce.word < de.length - 1 ? Z.nextWord() : (Z.reset(), Y.change(), te.reset());
      }
      function n() {
    ...
    return (
      ...
      Z.subscribe((t) => {
        ...
        1 === t.char && 0 === t.word
          ? (r && s(),
            (r = setInterval(() => {
              e.char < pe[e.word].length - 1 ? (e.char++, n(e)) : e.word < pe.length - 1 ? (e.word++, (e.char = 0), n(e)) : s();
            }, 6e4 / 6.2 / me)))
          : t.word === a && t.char === l && o();
      }),
    ...
    return {
      c() {
        (t = y("span")),
          ...
          E(t, "typed-by-target", e[3] && (e[4].word > e[7] || (e[4].char >= e[10] && e[4].word === e[7])));
      },
      m(e, r) {
        g(e, t, r), m(t, n);
      },
      p(e, s) {
        1 & s && r !== (r = (" " === e[8] ? "·" : e[8]) + "") && x(n, r),
          ...
          24 & s && E(t, "typed-by-target", e[3] && (e[4].word > e[7] || (e[4].char >= e[10] && e[4].word === e[7])));
      },
      d(e) {
        e && w(t);
      },
  ...
  function ve(e) {
    ...
    return {
      c() {
        ...
        $(t, "class", "word svelte-rtsb3r"), E(t, "current-word", e[1].word === e[7]), E(t, "typed", e[1].word > e[7]);
      },
      m(e, n) {
        g(e, t, n);
      ...
      p(e, s) {
        ...
        2 & s && E(t, "current-word", e[1].word === e[7]), 2 & s && E(t, "typed", e[1].word > e[7]);
      },
      d(e) {
        e && w(t), b(r, e);
      },
  ...
  function $e(e, t, n) {
    let r, s, o, a, l;
    return i(e, Y, (e) => n(0, (r = e))), i(e, Z, (e) => n(1, (s = e))), i(e, te, (e) => n(2, (o = e))), i(e, fe, (e) => n(3, (a = e))), i(e, ge, (e) => n(4, (l = e))), [r, s, o, a, l];
  }
  class xe extends V {
    constructor(e) {
  ...
  function je(e, r = {}) {
    ...
    function l(l, i) {
      ...
      let c = o,
        d = !1,
        { delay: m = 0, duration: g = 400, easing: w = t, interpolate: b = Fe } = n(n({}, r), i);
      const y = u() + m;
      let v;
      return (
        (o = (function (e) {
          ...
          if (t < y) return !0;
          d || ((v = b(e, l)), "function" == typeof g && (g = g(e, l)), (d = !0)), c && (c.abort(), (c = null));
          const n = t - y;
  ...
  function Ce(t) {
    ...
    return {
      ...
      m(e, h, p) {
        g(e, n, h), m(n, r), m(r, s), m(r, o), m(o, a), m(r, l), m(n, i), m(i, c), m(i, d), t[3](d), m(i, u), p && f(), (f = k(c, "input", t[2]));
      },
      p(e, [t]) {
        2 & t && x(a, e[1]);
      },
    ...
    return (
      (e.$$.update = () => {
        if (3 & e.$$.dirty) {
          ...
          s && (n(0, (s.style.left = e + "%"), s), n(0, (s.style.animationDuration = 50 / (e + 10) + "s"), s));
        }
      }),
      [
        s,
    ...
    return {
      c() {
        (t = y("div")),
          ...
          (A = v(O)),
          (D = y("div")),
          (D.innerHTML = '<p class="svelte-12n1c2w">compete with your target speed</p>'),
  ...
  function Se(e, t, n) {
    let r, s, o, a, l, d, u;
    i(e, ue, (e) => n(6, (r = e))), i(e, Z, (e) => n(7, (s = e))), i(e, Y, (e) => n(8, (o = e))), i(e, ne, (e) => n(1, (l = e))), i(e, fe, (e) => n(3, (u = e)));
    let f = je(0);
    i(e, f, (e) => n(0, (a = e)));
    let h = je(0);
    return (
      i(e, h, (e) => n(2, (d = e))),
      (e.$$.update = () => {
        192 & e.$$.dirty && r.key && " " !== r.key && 1 === s.char && 0 === s.word && ne.typingStarted(),
    ...
    return {
      c() {
        (t = y("div")),
          ...
          $(t, "class", (h = "key " + e[0][e[2]].label + " " + (e[1].key === e[2] ? "pressed" : "") + " svelte-1tksfjy"));
      },
      m(e, h) {
        g(e, t, h), m(t, n), m(n, r), m(t, s), m(s, o), m(o, a), m(o, l), m(s, i), m(i, c), m(i, d), m(i, u), m(i, f);
      },
      p(e, n) {
        1 & n && p !== (p = e[2] + "") && x(r, p),
          ...
          3 & n && h !== (h = "key " + e[0][e[2]].label + " " + (e[1].key === e[2] ? "pressed" : "") + " svelte-1tksfjy") && $(t, "class", h);
      },
      d(e) {
        e && w(t);
      },
    ...
    return {
      c() {
        N(i.$$.fragment),
          ...
          (s = y("div")),
          (s.innerHTML =
            '<div class="app svelte-1no0zd6">cybertype</div><div class="info svelte-1no0zd6"><div class="app svelte-1no0zd6"><div class="version"> V.1.0</div></div><div class="creator"><p class="svelte-1no0zd6"> Designed by</p><a href="https://twitter.com/MananTank_" target="black" class="svelte-1no0zd6"> Manan Tank</a></div></div>'),
          $(n, "class", "reset svelte-1no0zd6"),
          $(r, "class", "theme-switch svelte-1no0zd6"),
          $(s, "class", "cybertype svelte-1no0zd6");
      },
      m(e, t, u) {
        X(i, e, t), X(c, e, t), X(d, e, t), g(e, n, t), g(e, r, t), g(e, s, t), (a = !0), u && o(l), (l = [k(n, "click", Re), k(r, "click", Xe)]);
      },
      p: e,
      i(e) {
        a || (W(i.$$.fragment, e), W(c.$$.fragment, e), W(d.$$.fragment, e), (a = !0));
      },
      o(e) {
  ...
  function Re() {
    ue.reset(), te.reset(), Z.reset(), ge.reset(), ge.stop(), ie.reset(), ne.reset();
  }
  function Ke(e) {
    return C(Xe), [];
  }
